 ...
 */
class ParksClosest : Fragment() {

    @Override
    fun onCreateView(inflater: LayoutInflater, container: ViewGroup,
                     savedInstanceState: Bundle): View {
        val rootView = inflater.inflate(R.layout.parks_closest_fragment, container, false)
        //call list view and populate it
        val parkList = rootView.findViewById(R.id.closeByParks) as ListView
