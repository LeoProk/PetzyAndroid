...
class ParksMap : Fragment() {
    ...
    fun onCreateView(inflater: LayoutInflater, container: ViewGroup,
        ...
        val rootView = inflater.inflate(R.layout.parks_map_fragment, container, false)
        // Gets the MapView from the XML layout and creates it
        mMapView = rootView.findViewById(R.id.parks_map) as MapView
